  ...
  <div class="container py-8 md:py-12">
    <div class="mx-auto max-w-4xl">
      ...
      <p class="mb-8 text-muted-foreground">
        Управление играми и локализациями.
      </p>

      <div class="mb-6">
        <Button @click="router.push('/admin/games/create')">Добавить игру</Button>
      </div>
            ...
            <div class="flex items-center gap-1">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" class="w-48">
                  <DropdownMenuItem @select="router.push(`/admin/games/${g.id}/edit`)">
                    Редактировать
                  </DropdownMenuItem>
