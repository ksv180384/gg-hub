...
import { postsApi, type CreatePostPayload } from '@/shared/api/postsApi';
  ...
  <div class="container py-8 md:py-12">
    <div class="mx-auto max-w-3xl space-y-6">
      <div class="flex items-center justify-between gap-3">
        <div>
          <h1 class="mb-1 text-3xl font-bold tracking-tight">Новый пост</h1>
          <p class="text-muted-foreground">
            Укажите текст и выберите, кому будет виден пост.
          </p>
        </div>
