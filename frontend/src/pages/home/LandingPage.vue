...
const heroImageAlt =
  'Управление гильдией в MMORPG на платформе gg-hub: ростер, рейды, конст-пати, аукцион, хранилище, ДКП и заявки';
...
const guildBenefits = [
  ...
  },
  {
    ...
    title: 'Рейды',
    desc: 'Рейд-лид создаёт дерево составов и открывает набор. Игроки подают заявки персонажами, а принятые участники занимают свободные слоты.',
  },
  {
...
const roleScenarios = [
  { role: 'Лидер', text: 'Состав, роли, заявки, аудит действий и настройки ДКП.' },
  { role: 'Офицер', text: 'Заявки, рейды, аукцион, банк и события в рамках выданных прав.' },
  { role: 'Рейд-лид', text: 'Набор игроков, сбор состава по слотам и фиксация посещения.' },
  { role: 'Казначей', text: 'Хранилище, аукцион и ДКП без отдельных таблиц.' },
  { role: 'Игрок', text: 'Гильдия, рейды, конст-пати, календарь и уведомления.' },
];
...
const features = [
  ...
  {
    title: 'Рейды',
    desc: 'Рейд-лид собирает дерево составов по слотам и открывает набор; игроки подают заявки персонажами и получают уведомление о решении.',
  },
  {
    title: 'Хранилище и ДКП',
  ...
  },
  {
    ...
    desc: 'Лоты из хранилища, ставки персонажами, завершение торгов, резервирование предметов и отдельная история аукциона.',
  },
  {
    title: 'Конст-пати',
    desc: 'Постоянные группы с приглашениями, передачей лидерства, собственным составом, хранилищем и журналом выдач.',
  },

  {
    title: 'Рулетка',
    desc: 'Общий список участников и синхронное вращение колеса в реальном времени для розыгрыша наград внутри гильдии.',
  },
  {
    title: 'История действий',
    desc: 'Аудит важных изменений гильдии с фильтрами по дате, категории, инициатору и тексту события.',
  },
];
...
const steps = [
  ...
  },
  {
    ...
    desc: 'Назначьте офицеров, выдайте права, добавьте события, рейды, аукцион и правила ДКП.',
    link: null,
  },
  {
    num: '04',
    title: 'Ведите активность гильдии',
    desc: 'Фиксируйте посещения, набирайте рейды, распределяйте лут, создавайте конст-пати и отслеживайте историю действий.',
    link: null,
  },
];
