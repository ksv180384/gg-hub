...
export const HOME_PAGE_SEO_TITLE =
  'Управление гильдией в MMORPG — рейды, аукцион и ДКП | gg-hub';

export const HOME_PAGE_SEO_DESCRIPTION =
  'gg-hub — бесплатная платформа для управления гильдией в MMORPG. Ведите состав, рейды и набор, конст-пати, аукцион, хранилище, ДКП, заявки, события и журнал действий.';

/** Видимый лид в hero: не менять без согласования — рендерится в hero. */
export const HOME_PAGE_LEAD =
  'Управление гильдией в MMORPG на gg-hub: ростер, заявки, рейды, конст-пати, аукцион, календарь, хранилище и ДКП — бесплатно, в одном интерфейсе.';
...
export const HOME_CAPABILITIES_ITEMS: readonly HomeCapabilityItem[] = [
  ...
  {
    title: 'Рейды и набор',
    desc: 'Дерево рейдов, группы и слоты, заявки персонажами и решения рейд-лида.',
  },
  {
    title: 'Гильдейский аукцион',
    desc: 'Лоты из хранилища, ставки, резервирование предметов и история торгов.',
  },
  {
    title: 'Конст-пати',
    desc: 'Постоянные группы с приглашениями, составом, своим хранилищем и историей.',
  },
  {
    title: 'Рулетка',
    desc: 'Синхронный розыгрыш наград между участниками гильдии в реальном времени.',
  },
  {
    title: 'История гильдии',
    desc: 'Журнал важных действий с фильтрами по дате, категории и инициатору.',
  },
];
...
export const HOME_SEO_INTRO_PARAGRAPHS: readonly string[] = [
  'В MMORPG гильдия быстро перерастает обычный чат. Нужно понимать, кто состоит в составе, кто записался в рейд, какие заявки ждут решения, кому выдали предметы и сколько ДКП осталось у каждого участника.',
  'gg-hub собирает эти процессы в одном интерфейсе. Discord можно оставить для общения и голоса, а ведение гильдии перенести в структурированную систему: ростер, заявки, календарь, рейды, конст-пати, аукцион, хранилище, ДКП и журнал действий.',
];
...
export const HOME_DISCORD_BLOCK_PARAGRAPHS: readonly string[] = [
  'Discord удобен для общения, но заявки, рейды, лут и ДКП быстро теряются в каналах и личных сообщениях. Таблицы требуют ручного обновления и не дают ролей, набора в рейды, аукциона и единой истории действий.',
  'gg-hub не заменяет Discord, а дополняет его: голос и основной чат остаются там, а состав, заявки, события, рейды, конст-пати, аукцион, хранилище и ДКП ведутся на сайте.',
];
...
export const HOME_FAQ_ITEMS: HomeFaqItem[] = [
  {
    ...
    answer:
      'Это веб-платформа, где лидер и офицеры ведут состав, заявки, календарь, рейды и набор, конст-пати, аукцион, хранилище, ДКП, блог, опросы и журнал действий. Игроки находят гильдию в каталоге и подают заявку по анкете.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Да. gg-hub не заменяет Discord: голос и основной чат остаются там. На сайте ведутся состав, заявки, календарь, рейды, конст-пати, аукцион, хранилище и ДКП. Для событий можно настроить напоминания в Discord.',
  },
  {
  ...
  {
    question: 'Можно ли собирать заявки в рейд?',
    answer:
      'Да. Рейд-лид открывает набор в конкретный рейд, игроки подают заявки своими персонажами, после чего заявку можно принять в свободный слот или отклонить. Решение приходит игроку в уведомлении.',
  },
  {
    question: 'Как работает гильдейский аукцион?',
    answer:
      'Офицер создаёт лот из предмета в хранилище и задаёт срок торгов. Участники делают ставки выбранными персонажами, а после завершения результат и все операции сохраняются в истории.',
  },
  {
    question: 'Что такое конст-пати на gg-hub?',
    answer:
      'Это постоянная группа персонажей в рамках одной игры и сервера. У неё есть лидер, приглашения, состав и отдельное хранилище с выдачами и историей.',
  },
  {
    question: 'Можно ли посмотреть историю действий гильдии?',
    answer:
      'Да. В журнале гильдии фиксируются важные изменения состава, доступа, настроек, событий, публикаций, банка, аукциона и рулетки. Записи фильтруются по дате, категории, инициатору и тексту.',
  },
];
...
export function buildHomeJsonLdGraph(
  ...
  const softwareApplication: Record<string, unknown> = {
    ...
    description:
      'Бесплатная веб-платформа: ростер, заявки, рейды, конст-пати, аукцион, календарь, хранилище, ДКП и журнал действий для гильдий в MMORPG.',
    url: canonicalUrl,
    ...
    featureList: [
      ...
      'Рейды с составом, набором и синхронизацией',
      'Хранилище гильдии и журнал ДКП',
      'Гильдейский аукцион со ставками и историей',
      'Конст-пати со своим составом и хранилищем',
      'Рулетка и история действий гильдии',
      'Блог, опросы и уведомления',
