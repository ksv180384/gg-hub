...
function socialUrl(provider: string) {
...
<template>
  <div class="flex flex-col gap-2">
    <a
      ...
      class="inline-flex h-9 w-full items-center justify-center gap-2 rounded-md border border-border bg-card px-4 text-sm font-semibold shadow-none transition-colors duration-150 hover:border-[#FC3F1D]/25 hover:bg-[#FC3F1D]/10 hover:text-[#FC3F1D] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/15"
    >
...
<!--      class="inline-flex h-9 w-full items-center justify-center gap-2 rounded-lg border border-border/80 bg-background px-4 text-sm font-semibold shadow-sm transition-all duration-150 hover:border-[#0077FF]/25 hover:bg-[#0077FF]/10 hover:text-[#0077FF] hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/15 active:translate-y-px"-->
<!--    >-->
<!--      <svg class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">-->
