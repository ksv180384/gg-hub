        ...
        <div class="flex flex-col gap-6 md:flex-row md:items-start">
          ...
          <div class="min-w-0 flex-1 order-2 md:order-2">
            ...
            <SettingsTab
              ...
              @update:dkpEnabled="model.dkpEnabled = $event"
              @update:selectedLeaderCharacterId="model.selectedLeaderCharacterId = $event"
            ...
            <ApplicationTab
              ...
              :description-text="model.applicationFormDescription"
              :description-saving="model.saving"
              ...
              @update:descriptionText="model.applicationFormDescription = $event"
              @save-description="model.saveApplicationFormDescription"
