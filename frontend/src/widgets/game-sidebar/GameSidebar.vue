...
<template>
  <aside
    class="flex w-56 shrink-0 flex-col border-r bg-[var(--sidebar)] text-[var(--sidebar-foreground)]"
    aria-label="Боковое меню"
  >
    <div class="flex h-14 items-center gap-2 border-b border-[var(--sidebar-border)] px-4">
