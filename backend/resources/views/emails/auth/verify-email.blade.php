...
<head>
    ...
    <title>Подтверждение email — {{ $appName }}</title>
    <style>
...
<body style="width: 100%; margin: 0; padding: 0; background-color: #03090d; color: #f6f2e9; font-family: Arial, Helvetica, sans-serif; -webkit-text-size-adjust: 100%;">
    <div style="display: none; max-height: 0; overflow: hidden; opacity: 0; color: transparent;">
        Один шаг до приключений вместе с сообществом {{ $appName }}.
    </div>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" role="presentation">
                                                        <tr>
                                                            <td align="center" bgcolor="#f7ba2b" style="border: 1px solid #ffd65b; border-radius: 5px; background-color: #f7ba2b; box-shadow: 0 6px 20px rgba(247, 186, 43, 0.16);">
                                                                <a href="{{ $verificationUrl }}" target="_blank" rel="noopener" style="display: inline-block; min-width: 220px; padding: 15px 28px; color: #11100c; font-size: 16px; font-weight: 700; line-height: 1.2; text-align: center; text-decoration: none;">
                                                                    Подтвердить email
                                                                </a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td style="padding-top: 22px; color: #879197; font-size: 12px; line-height: 1.55; text-align: left;">
                                                    <p style="margin: 0 0 8px;">
                                                        Если кнопка «Подтвердить email» не открывается, скопируйте ссылку и вставьте её в адресную строку браузера:
                                                    </p>
                                                    <p style="margin: 0; word-break: break-all;">
                                                        <a href="{{ $verificationUrl }}" style="color: #d8a52e; text-decoration: underline; word-break: break-all;">
                                                            {{ $verificationUrl }}
                                                        </a>
                                                    </p>
                                                </td>
