...
Аукцион гильдии использует те же предметы хранилища и ДКП-балансы пользователей. Подробная документация по лотам, ставкам, автоматическому закрытию и уведомлениям: [guild-auction.md](guild-auction.md).
