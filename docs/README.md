...
| История действий гильдии | [guild-activity.md](guild-activity.md) |
| Конст пати | [constant-party.md](constant-party.md) |
| Рейды, составы и заявки | [raids.md](raids.md) |
...
В июле–августе 2026 года в приложение добавлены:

- **история гильдии**: единый журнал аукциона, рулетки, хранилища, состава, ролей и прав, настроек, постов и событий с фильтрами и пагинацией;
- **конст-пати**: приглашения и состав, передача лидерства, выход и роспуск, хранилище с остатками, выдачами и неизменяемым журналом; realtime-чат подготовлен и управляется feature flag;
- **расширенные рейды**: дерево составов, просмотр участников дочерних рейдов, открытие набора, заявки персонажей и принятие в свободный слот;
- **объединение игровых серверов**: фоновый перенос персонажей, гильдий и конст-пати с отображением прогресса и продолжением после ошибки;
- **улучшения профиля и админки**: светлая, тёмная или системная тема пользователя, общий каталог персонажей с фильтрами и сортировкой;
- **уведомления**: контекст игры и гильдии, события по заявкам в рейд и автоматическое удаление записей старше трёх месяцев.

Подробности: [guild-activity.md](guild-activity.md), [constant-party.md](constant-party.md), [raids.md](raids.md), [server-merge.md](server-merge.md) и [08-uvedomleniya.md](08-uvedomleniya.md).
